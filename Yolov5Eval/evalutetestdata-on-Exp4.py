...
# 文件夹路径
ground_truth_folder = '/data01/user1/FinalProject/2024testdataExt/labels/'  # 真值laebl文件夹路径
detected_folder = '/data01/user1/FinalProject/yolov5/runs/detect/exp11/labels/'  # 预测laebl文件夹路径 predict9
